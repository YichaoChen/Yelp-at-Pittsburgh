...
public class MyIndexReader {
    ...
    public MyIndexReader(String dataType) throws IOException {
        ...
        // directory = FSDirectory.open(Paths.get("//Users//zigchg//NetBeansProjects//IRFinalProject//web//assets//indextext"));
        
        String path = ""+this.getClass().getClassLoader().getResource("indextext");
        
        path = path.replaceAll("file:", "");
        
        // directory = FSDirectory.open(Paths.get("//Users//zigchg//NetBeansProjects//IRFinalProject//build//web//WEB-INF//classes//indextext"));
